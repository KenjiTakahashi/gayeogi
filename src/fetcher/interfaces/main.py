...
class Ui_main(object):
    def setupUi(self, main):
        ...
        self.formLayout_3.setWidget(0, QtGui.QFormLayout.FieldRole, self.artistsStats)
        ...
        self.formLayout_3.setWidget(0, QtGui.QFormLayout.LabelRole, self.albumsStats)
        self.local = QtGui.QPushButton(self.widget_2)
        self.local.setObjectName(_fromUtf8("local"))
        self.formLayout_3.setWidget(1, QtGui.QFormLayout.FieldRole, self.local)
        self.settings = QtGui.QPushButton(self.widget_2)
        self.settings.setObjectName(_fromUtf8("settings"))
        self.formLayout_3.setWidget(1, QtGui.QFormLayout.LabelRole, self.settings)
        self.remote = QtGui.QPushButton(self.widget_2)
        self.remote.setObjectName(_fromUtf8("remote"))
        self.formLayout_3.setWidget(2, QtGui.QFormLayout.FieldRole, self.remote)
