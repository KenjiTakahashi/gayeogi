...
class Main(QtGui.QMainWindow):
    ...
    def __init__(self):
        ...
        selection = QtGui.QItemSelectionModel(self.db.albums)
        self.ui.albums.setSelectionModel(selection)
        selection.selectionChanged.connect(self.db.tracks.setSelection)
